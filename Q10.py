...
class ArvoreBinaria:
    ...
    def valor_maximo(self, no):
        if no is None:
            return 0
        elif no.direita is None:
            return no.valor
        else:
            return self.valor_maximo(no.direita)
...
encontrarValorMaximo = arvore.valor_maximo(arvore.raiz)
print('Valor máximo encontrado na árvore: ', encontrarValorMaximo)
